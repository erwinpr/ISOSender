...
public class RepeatServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {        
            ...
            int tempInt,repeater;
            long tempLong;
            
            repeater = Integer.parseInt(repeatVal);
            ...
            for(int k = 0;k < repeater; k++) {
                ...
                switch(oprType) {
                    ...
                    sample = "0200A23A511008810000"+bit3+"0225024043"+ bit11 +"024043022502254444" +bit37 + callerId + "      " + bit48Prefix + bit48;
                ...
                if(serverResp.trim().isEmpty()) {
                    nack = nack + 1;
                }else{
                    ack = ack + 1;
                }
            }
            responseMap.put("Success", Integer.toString(ack));
            responseMap.put("Failed", Integer.toString(nack));
            String json = "";
