...
<html>
    ...
    <body>
        ...
        <form id="frmTestServlet" name="frmTestServlet" method="POST" action="SenderServlet">
            ...
            <label class="labela" for="bit3Value">Bit 3</label> <input id="bit3Value" name="bit3Value" type="text" value="253001"><br/>
            ...
            <label class="labela" for="oprType">Operation Type</label> <select id="oprType" name="oprType">
                <option value="">--</option>
                <option value="inquiry_cif">Inquiry CIF</option>
                <option value="inquiry_cif_next">Inquiry CIF Next</option>
