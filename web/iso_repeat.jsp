...
<html>
    ...
    <body>
        ...
        <form id="frmTestServlet" name="frmTestServlet" method="POST" action="RepeatServlet">
            ...
            <label class="labela" for="repeatVal">Repeat Request</label> <input id="repeatVal" name="repeatVal" type="text" value="10"><br/>
            <div id="divref1">
