...
<html>
    ...
    <body>
        ...
        <form id="frmTestServlet" name="frmTestServlet" method="POST" action="SenderServlet">
            ...
            <label class="labela" for="bit3Value">Bit 3</label> <input id="bit3Value" name="bit3Value" type="text" value="490001"><br/>
            <label class="labela" for="bit11Value">Bit 11</label> <input id="bit11Value" name="bit11Value" type="text" value="811560"><br/>
            <label class="labela" for="bit37Value">Bit 37</label> <input id="bit37Value" name="bit37Value" type="text" value="251733656390"><br/>
            <label class="labela" for="oprType">Operation Type</label> <select id="oprType" name="oprType">
                ...
                <option value="iso_62">Use Free Format Bit 48 and Bit 62</option>
            </select><br/>
            ...
            <div id="divref1">
                <label id="lblBit62" class="labela" for="bit48Value">Bit 62</label> <input id="bit62Value" name="bit62Value" type="text" size="110"><br/>
            </div>
            <div id="divref2">
